...
class Ui_MainWindow(QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        try:
            self.frame_taker.cancel()  # may be None
    ...
    def init_left(self):
        ...
        self.verticalLayout_config = QtWidgets.QVBoxLayout(
        ...
        self.formLayout.setWidget(
            0, QtWidgets.QFormLayout.FieldRole, self.combo_iso)
        ...
        self.combo_shutter.addItems(("bulb", "30", "25", "20", "15", "13", "10.3", "8", "6.3", "5", "4", "3.2", "2.5", "2", "1.6", "1.3", "1", "0.8", "0.6", "0.5", "0.4", "0.3", "1/4", "1/5", "1/6", "1/8", "1/10", "1/13", "1/15",
                                     "1/20", "1/25", "1/30", "1/40", "1/50", "1/60", "1/80", "1/100", "1/125", "1/160", "1/200", "1/250", "1/320", "1/400", "1/500", "1/640", "1/800", "1/1000", "1/1250", "1/1600", "1/2000", "1/2500", "1/3200", "1/4000"))
        self.combo_shutter.setCurrentText("1")
        self.formLayout.setWidget(
            1, QtWidgets.QFormLayout.FieldRole, self.combo_shutter)
        ...
        self.formLayout.setWidget(
            2, QtWidgets.QFormLayout.FieldRole, self.combo_format)
        ...
        self.formLayout.setWidget(
            3, QtWidgets.QFormLayout.FieldRole, self.spin_interval)
        ...
        self.formLayout.setWidget(
            4, QtWidgets.QFormLayout.FieldRole, self.line_subfolder)
        ...
        self.formLayout.setWidget(
            5, QtWidgets.QFormLayout.FieldRole, self.line_filename)
        ...
        # many digits, to make the box wider
        self.spin_start.setMaximum(999999999)
        self.formLayout.setWidget(
            6, QtWidgets.QFormLayout.FieldRole, self.spin_start)
        ...
        # self.threadpool.start(self.ticker)
        self.gridLayout_left_buttons.addWidget(
            self.button_continuous, 0, 1, 1, 1)
    ...
    def take_frame(self):
        ...
        cmds = [
            f"gphoto2 {iso} {shutter} --filename={self.subfolder}{self.filename} --force-overwrite --port usb --capture-image-and-download"]
        # cmds.append("sleep 2")
